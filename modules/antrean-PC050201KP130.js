...
/* ===========================================================
   TOGGLE STATUS ANTREAN (MODULAR v9)
=========================================================== */
function toggleStatusAntrean(noAntrean, status) {
    ...
    update(ref(db, "data_antrean/" + key), updateData);
}

/* ===========================================================
   MODAL INFO ANTREAN (MODULAR v9)
=========================================================== */
...
=========================================================== */
window.renderTableAntrean = renderTableAntrean;
window.toggleStatusAntrean = toggleStatusAntrean;
window.bukaInfoAntrean = bukaInfoAntrean;
window.isiModalInfo = isiModalInfo;
