...
function loadDashboardStats() {
    const path = ref(db, "data_antrean");
...
/* ===========================================================
   ⬇️ WAJIB UNTUK SISTEM MODULAR
=========================================================== */
window.loadDashboardStats = loadDashboardStats;
window.renderDashboard = renderDashboard;
window.loadDashboardFromFirebase = loadDashboardFromFirebase;

window.buildDailyChart = buildDailyChart;
window.buildMonthlyChart = buildMonthlyChart;
window.buildKeperluanChart = buildKeperluanChart;
window.buildKeperluanPie = buildKeperluanPie;
window.buildLainnyaChart = buildLainnyaChart;
