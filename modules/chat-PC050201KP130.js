...
/* ===========================================================
   REALTIME CHAT LISTENER (MODULAR)
=========================================================== */
onValue(ref(db, "chat_messages"), (snapshot) => {
  ...
  Object.entries(data).forEach(([key, msg]) => {
    const currentPetugas =
      localStorage.getItem("namaPetugas") || "Petugas";
...
function hapusPesan(key) {
  ...
  remove(ref(db, "chat_messages/" + key));
}

/* ===========================================================
   GLOBAL EXPORT (WAJIB UNTUK HTML)
=========================================================== */
window.cekAutoBukaChat = cekAutoBukaChat;
window.sendMessage = sendMessage;
window.toggleChatVisibility = toggleChatVisibility;
window.toggleChatVisibilityLocal = toggleChatVisibilityLocal;
window.updateChatUserIdentity = updateChatUserIdentity;
window.hapusPesan = hapusPesan;
